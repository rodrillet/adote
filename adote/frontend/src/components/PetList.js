...
import Logout from './Logout'; // Adicione esta linha para importar o componente Logout
...
const PetList = () => {
  ...
  const fetchPets = async () => {
    try {
      ...
      setError('Não foi possível carregar a lista de pets. Por favor, tente novamente mais tarde.');
    } finally {
      setLoading(false);
    }
  };
  ...
  // Utilizando useMemo para otimizar a filtragem de pets
  ...
  }, [pets, searchTerm, ageFilter, genderFilter]);
    ...
    <div className="flex flex-col min-h-screen bg-gray-100 font-sans">
      ...
      <main className="flex-grow">
        ...
        <div className="container mx-auto px-6 py-12">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center mb-8 space-y-4 md:space-y-0 md:space-x-4">
            ...
            <div className="relative w-full max-w-md">
              <input
                ...
                aria-label="Pesquisar pets por nome ou raça"
              />
              <svg
            ...
            <div>
              <select
                ...
                aria-label="Filtrar pets por idade"
              >
            ...
            <div>
              <select
                ...
                className="w-full md:w-48 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                aria-label="Filtrar pets por sexo"
              >
          ...
          {loading && (
            <p className="text-center text-gray-600">Carregando pets...</p>
          )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredPets.map((pet) => (
                  ...
                  >
                    {pet.imagem ? (
                      <img
                        src={`${process.env.REACT_APP_API_URL}/uploads/${pet.imagem}`}
